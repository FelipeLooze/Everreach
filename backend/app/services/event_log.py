...
EVENT_IMPORTANCE = {
    ...
    EventType.BUSINESS_FOUNDED: 3,
    EventType.BUSINESS_CLOSED: 3,
    EventType.BUSINESS_OPERATOR_CHANGED: 2,
    EventType.BUSINESS_FUNDS_CHANGED: 1,
    EventType.ECONOMIC_DISRUPTION_APPLIED: 3,
